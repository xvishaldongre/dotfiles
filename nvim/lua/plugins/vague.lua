return {
    ...
    transparent = true,
		on_highlights = function(hl, c)
			...
			-- Blink popups
			hl.BlinkCmpDoc = { bg = popup_bg, fg = c.fg }
			hl.BlinkCmpDocBorder = { bg = popup_bg, fg = border_color }
			hl.BlinkCmpSignatureHelp = { bg = popup_bg, fg = c.fg }
			hl.BlinkCmpSignatureHelpBorder = { bg = popup_bg, fg = border_color }

			hl.BlinkCmpMenu = { bg = popup_bg, fg = c.fg }
			hl.BlinkCmpMenuBorder = { bg = popup_bg, fg = border_color }
			...
			hl.MiniStatuslineModeNormal = { fg = c.bg, bg = c.operator }
